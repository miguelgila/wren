...
# Verify
kubectl get crd mpijobs.hpc.cscs.ch &>/dev/null && ok "  MPIJob CRD registered" || fail "  MPIJob CRD missing"
...
echo "  Check status:  kubectl get mpijob hello-bubo -o wide"
echo "  Watch:         kubectl get mpijob hello-bubo -w"
echo ""
...
echo "  Check status:  kubectl get mpijob topology-aware-job -o yaml"
echo ""
...
echo "  List all jobs: kubectl get mpijobs"
echo ""
...
echo "  kubectl get mpijobs                         # List all jobs"
echo "  kubectl get mpijob <name> -o yaml           # Job details"
...
echo "  kubectl delete mpijob --all"
