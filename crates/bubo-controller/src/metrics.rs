...
impl Metrics {
    pub fn new() -> Self {
        ...
        let scheduling_latency = HistogramVec::new(
            HistogramOpts::new(
                "bubo_scheduling_latency_seconds",
        ...
        let cpu_utilization = prometheus::Gauge::new(
            "bubo_cluster_cpu_utilization_ratio",
        ...
        let memory_utilization = prometheus::Gauge::new(
            "bubo_cluster_memory_utilization_ratio",
        ...
        let gpu_utilization = prometheus::Gauge::new(
            "bubo_cluster_gpu_utilization_ratio",
...
mod tests {
    ...
    fn test_scheduling_latency_histogram() {
        ...
        let latency = families
            .iter()
            .find(|f| f.get_name() == "bubo_scheduling_latency_seconds");
    ...
    fn test_job_wait_time_histogram() {
        ...
        let wait = families
            .iter()
            .find(|f| f.get_name() == "bubo_job_wait_seconds");
        assert!(wait.is_some());
    }
    ...
    fn test_queue_depth_tracking() {
        ...
        let depth = families
            .iter()
            .find(|f| f.get_name() == "bubo_queue_depth");
    ...
    fn test_cluster_utilization_metrics() {
        ...
        let cpu = families
            .iter()
            .find(|f| f.get_name() == "bubo_cluster_cpu_utilization_ratio");
        assert!(cpu.is_some());
    }
    ...
    fn test_reservation_tracking() {
        ...
        let res = families
            .iter()
            .find(|f| f.get_name() == "bubo_active_reservations");
        assert!(res.is_some());
    }
    ...
    fn test_topology_score_histogram() {
        ...
        let topo = families
            .iter()
            .find(|f| f.get_name() == "bubo_topology_placement_score");
        assert!(topo.is_some());
    }
}
